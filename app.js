...
//connect and create to the database called blogProject
mongoose.connect("mongodb://127.0.0.1:27017/blogProject");


//creating new schema for the database 
...
app.post("/compose", function(req, res){
  ...
  // posts.push(post); this pushes the post to the array

  post.save(); // this saves the post into the database
  res.redirect("/");
